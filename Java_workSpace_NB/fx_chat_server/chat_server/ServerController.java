...
public class ServerController implements Initializable{
	...
	// 운영체제에서 요청한 포트로 프로세스를 할당받아 client socket 연결관리 할 class
	ServerSocket server;
	// 연결된 client 의 닉네임을 key 값으로 서버에서 발신할 정보를 value 로 저장하는 Map 객체
	...
	public void startServer() {
		...
		// 해당 포트 번호를 할당받아서 client 에 연결 요청을 수락할 수 있도록 serverSocket 생성
		// 1023 < portNumber || 65535 > postNumber
		try {
		...
		// Thread Pool 에서 관리되는 Thread 에서 필요한 작업을 전달.
	...
	// 작업 스레드에서 textArea 에 출력하는 UI 작업을 처리
