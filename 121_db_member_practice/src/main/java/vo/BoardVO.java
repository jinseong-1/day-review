...
public class BoardVO {
	...
	private char qna_delete;		// 삭제요청

	public BoardVO() {}
	
	// 게시글 삽입에 필요한 생성자
	public BoardVO(int qna_num, String qna_name, String qna_title, String qna_content) {
	...
	public BoardVO(int qna_num, String qna_name, String qna_title, String qna_content, int qna_re_ref, int qna_re_lev,
			int qna_re_seq, int qna_writer_num, int qna_readcount, Date qna_date) {
		this.qna_num = qna_num;
		this.qna_name = qna_name;
		this.qna_title = qna_title;
		this.qna_content = qna_content;
	...
	public String toString() {
		return "BoardVO [qna_num=" + qna_num + ", qna_name=" + qna_name + ", qna_title=" + qna_title + ", qna_content="
				+ qna_content + ", qna_re_ref=" + qna_re_ref + ", qna_re_lev=" + qna_re_lev + ", qna_re_seq="
				+ qna_re_seq + ", qna_writer_num=" + qna_writer_num + ", qna_readcount=" + qna_readcount + ", qna_date="
				+ qna_date + ", qna_delete=" + qna_delete + "]";
	}
