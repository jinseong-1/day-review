 ...
 * 한번에 보여줄 게시물 갯수 : perPageNum
 * 전체 게시물 갯수 : totalCount
 */
public class PageMaker {
	
	/**
	 * 페이징 처리에 따른 table 에 저장된 게시물의 검색 기준을 정하는 class
	 * page, perPageNum startRow
	 */
	protected Criteria cri;
	
	/**
	 * <b>database</b>에 저장된 전체 row 갯수
	 */
	...
	/**
	 * displayPageNum 와 사용자가 요청한 페이지 번호를 따라 현재 페이지에서 보여줄 이동가능한 게시판 화면의 시작 페이지 번호
	 */
	private int startPage;
	
	/**
	 * displayPageNum 와 사용자가 요청한 페이지 번호를 따라 현재 페이지에서 보여줄 이동가능한 게시판 화면의 마지막 페이지 번호
	 */
	private int endPage;
	...
	/**
	 * first - 첫 페이지 버튼 활성화 유무, 현재 페이지가 시작페이지(1)인지 여부 확인<br/>
	 * last - 마지막 페이지 버튼 활성화 엽, 현재 페이지가 마지막(maxPage)인지 여부 확인<br/>
	 * prev - 이전 페이지 버튼 활성화 여부, 이전 페이지 블럭에서 이동가능 여부<br/>
	 * next - 다음 페이지 버튼 활성화 여부, 다음 페이지 블럭에서 이동가능 여부<br/>
	 */
